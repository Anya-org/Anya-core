...
- Total markdown files: 626
- Broken links found: 471
- Links fixed automatically: 5
- Links requiring manual review: 466

## Links Fixed Automatically

| Source File | Link Text | Old Path | New Path |
|-------------|-----------|----------|----------|
| anya-enterprise/docs/security/incident-response.md | Security Policies | ./security-policies.md | ../../../dependencies/docs/security/security-policies.md |
| docs/SECURITY_GUIDELINES.md | Compliance Framework | ../compliance/framework.md | ../anya-enterprise/docs/audit/framework.md |
| anya-enterprise/docs/audit/framework.md | Compliance Management | ./compliance-management.md | ../security/compliance-management.md |
| anya-enterprise/docs/audit/framework.md | Security Monitoring | ./security-monitoring.md | ../security/security-monitoring.md |
| anya-enterprise/docs/audit/framework.md | Incident Response | ./incident-response.md | ../security/incident-response.md |
...
| anya-enterprise/docs/security/compliance-management.md | Risk Management | ../risk/management.md | No suggestion |
| scripts/README_UPDATE_DOCS.md | MIT License | ../LICENSE | No suggestion |
| anya-enterprise/docs/security/incident-response.md | Business Continuity Plan | ../business-continuity/plan.md | No suggestion |
...
| anya-enterprise/docs/audit/framework.md | Risk Management | ../risk/management.md | No suggestion |
