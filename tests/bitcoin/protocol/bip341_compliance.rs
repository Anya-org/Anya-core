...
impl BIP341Checker {
    ...
    pub fn test_vector_key_path_spend(&self, internal_key_hex: &str, output_key_hex: &str) -> Result<bool> {
        // Parse keys from hex
...
mod additional_tests {
    ...
    fn test_tapleaf_verification() {
        ...
        println!("Address verification attempted: {}", address_result.is_err());
