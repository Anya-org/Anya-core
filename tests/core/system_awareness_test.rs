use anya_core::core::system_awareness::{
    NetworkStateMonitor, SecurityMonitor, 
    MempoolStatus, BlockVersionMetrics, SecurityAlert,
    AlertSeverity, SecurityAlertType, FeeAnalysis, NetworkClient, 
    MempoolInfo, BlockInfo, FeeStats, Result
};
    ...
    fn new() -> Self {
        Self {
            ...
            blocks: vec![
                ...
                BlockInfo {
                    hash: "000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26e".to_string(),
                    height: 1,
                    version: 1,
                    miner: Some("Satoshi".to_string()),
                },
                BlockInfo {
                    hash: "0000000069e244f73d78e8fd29ba2fd2ed618bd6fa2ee92559f542fdb26e7c1d".to_string(),
                    height: 2,
                    version: 2,
