...
#[cfg(test)]
mod tests {
    use crate::bip::bip353::{BetaFeatures, Bip353, Bip353Config, Bip353Status, PaymentRecipient};
    use mockall::mock;
    ...
    async fn test_parse_address_valid() {
        ...
        let recipient_with_prefix = bip353
            .parse_address("₿user@example.com")
    ...
    async fn test_parse_address_non_ascii() {
        ...
        let bip353_with_non_ascii =
            Bip353::new(config_with_non_ascii).expect("Failed to create BIP353 instance");

        let bip353_without_non_ascii =
            Bip353::new(config_without_non_ascii).expect("Failed to create BIP353 instance");
    ...
    fn test_feature_enablement() {
        ...
        // Create instances
        let disabled_bip353 =
            Bip353::new(disabled_config).expect("Failed to create BIP353 instance");
