...
impl BipHealthReport {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        md.push_str(&format!("- Overall Health: **{}**\n", if self.healthy { "Healthy ✅" } else { "Needs Attention ⚠️" }));
        md.push_str(&format!("- Total BIPs Supported: **{}**\n", self.total_supported));
        md.push_str(&format!("- Fully Compliant: **{}**\n", self.compliant_count));
        md.push_str(&format!("- Partially Compliant: **{}**\n", self.partial_count));
        md.push_str(&format!("- Beta Features: **{}**\n", self.beta_count));
        md.push_str(&format!("- Missing/Not Implemented: **{}**\n", self.missing_count));
        md.push_str(&format!("- Proposals Tracked: **{}**\n\n", self.proposal_count));
        ...
        for bip_key in &bips {
            if let Some(bip) = self.bips.get(*bip_key) {
                ...
                md.push_str(&format!("- **Industry Adoption**: {}\n", bip.industry_adoption));
                ...
                md.push_str(&format!("- **Beta Feature**: {}\n", if bip.is_beta { "Yes" } else { "No" }));
...
impl BipHealthChecker {
    ...
    fn init_known_bips(&mut self) {
        // Schnorr Signatures
        self.known_bips.insert("BIP-340".to_string(), BipDetail {
        ...
        // Taproot
        self.known_bips.insert("BIP-341".to_string(), BipDetail {
        ...
        // Tapscript
        self.known_bips.insert("BIP-342".to_string(), BipDetail {
        ...
        // PSBT
        self.known_bips.insert("BIP-174".to_string(), BipDetail {
        ...
        // PSBT Version 2
        self.known_bips.insert("BIP-370".to_string(), BipDetail {
        ...
        self.known_bips.insert("BIP-353".to_string(), BipDetail {
            bip: "BIP-353".to_string(),
            name: "DNS Payment Instructions".to_string(),
            description: "DNS-based Bitcoin Payment Instructions using bitcoin@domain.tld identifiers".to_string(),
            status: ComplianceStatus::Missing, // Will be checked later
        ...
        self.known_bips.insert("BIP-329".to_string(), BipDetail {
        ...
        self.known_bips.insert("BIP-322".to_string(), BipDetail {
        ...
        self.known_bips.insert("BIP-119".to_string(), BipDetail {
        ...
        self.known_bips.insert("BIP-118".to_string(), BipDetail {
            bip: "BIP-118".to_string(),
            name: "SIGHASH_ANYPREVOUT".to_string(),
            description: "New sighash flag for non-input-specific transaction signatures".to_string(),
            status: ComplianceStatus::Missing, // Will be checked later
        ...
        // BIP-374: DLEQ Proofs
        self.known_bips.insert("BIP-374".to_string(), BipDetail {
            ...
            status: ComplianceStatus::Missing, // Will be checked later
            implementation: "Experimental implementation in security/crypto/dleq.rs".to_string(),
            is_beta: true,
    ...
    fn init_known_proposals(&mut self) {
        ...
        self.known_proposals.insert("musig2".to_string(), BipDetail {
            bip: "musig2".to_string(),
            name: "MuSig2".to_string(),
            description: "Multisignature scheme using Schnorr signatures".to_string(),
            status: ComplianceStatus::Partial,
            implementation: "Experimental implementation in security/crypto/musig.rs".to_string(),
            is_beta: true,
        ...
        self.known_proposals.insert("erlay".to_string(), BipDetail {
            bip: "erlay".to_string(),
        ...
        // Ephemeral Anchors
        self.known_proposals.insert("ephemeral_anchors".to_string(), BipDetail {
        ...
        self.known_proposals.insert("frost".to_string(), BipDetail {
            bip: "frost".to_string(),
        ...
        self.known_proposals.insert("channel_jamming".to_string(), BipDetail {
            bip: "channel_jamming".to_string(),
            name: "Channel Jamming Mitigation".to_string(),
            description: "Protocol for upfront and hold fees to address channel jamming".to_string(),
            status: ComplianceStatus::Missing,
            implementation: "Not implemented".to_string(),
            is_beta: true,
            test_coverage: None,
        ...
        self.known_proposals.insert("matt".to_string(), BipDetail {
            bip: "matt".to_string(),
            name: "MATT".to_string(),
