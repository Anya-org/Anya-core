...
pub mod mock {
    ...
    pub fn verify_transaction(tx_hex: &str) -> bool  -> Result<(), Box<dyn Error>> {
    ...
    pub fn verify_psbt(psbt_base64: &str) -> bool  -> Result<(), Box<dyn Error>> {
    ...
    pub fn get_test_transactions() -> Vec<(&'static str, bool)>  -> Result<(), Box<dyn Error>> {
        vec![
