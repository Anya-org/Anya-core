...
pub fn generate_taproot_commitment(_data: data: &[u8][u8], salt: &[u8; 32]) -> TapBranchHash {
...
impl TaprootDLC {
    ...
    pub fn execute(
        &mut self,
        outcome_id: &str,
        oracle__signature: signature: &[u8][u8],
    ...
    pub fn verify_oracle_signature(&self, outcome_id: &str, _signature: signature: &[u8][u8]) -> Result<bool, &'static str> {
