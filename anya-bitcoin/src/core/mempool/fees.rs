...
impl FeeEstimator {
    ...
    fn add_to_bucket_list(buckets: &mut Vec<FeeBucket>, fee_rate: f64, count: usize, total_fee: u64) {
    ...
    pub fn update_estimates(&self, recent_txs: &[Transaction]) -> AnyaResult<()> {
        ...
        info!("Updated fee estimates: {} transactions confirmed", confirmed_count);
        Ok(())
    }
