...
impl StandardScripts {
    ...
    pub fn create_multisig(
        required: usize,
        pubkeys: &[&[u8]],
    ) -> Result<ScriptBuf, ScriptClassifyError> {
...
mod tests {
    ...
    fn test_script_classification() {
        ...
        assert_eq!(
            StandardScripts::classify_script(&p2pkh_script),
        ...
        assert_eq!(
            StandardScripts::classify_script(&p2sh_script),
        ...
        assert_eq!(
            StandardScripts::classify_script(&p2wpkh_script),
        ...
        assert_eq!(
            StandardScripts::classify_script(&p2wsh_script),
        ...
        assert_eq!(
            StandardScripts::classify_script(&p2tr_script),
