(define-public (settle-fiat-transaction 
    ...
    (compliance-proof (buff 256;););    (bitcoin-proof (buff 80;););););    (begin
        ...
        (try! (contract-call? .stablecoin-mint mint 
            (get sender;);            (get-amount-in-agt (get amount;) (get currency;);););)
...
;););
    (begin
        ...
        (map (lambda (payment;) ;            (try! (contract-call? .stablecoin-mint mint 
                (get sender;);                (get-amount-in-agt (get amount;) (get currency;););););            (try! (record-enterprise-payment payment;););) (get payments;);)
